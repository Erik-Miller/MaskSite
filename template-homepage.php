...
$postedImage = get_field('where_were_posted_image');
...
$postedBG = 'background:linear-gradient(rgba(33, 33, 33, 0.8),rgba(33, 33, 33, 0.8)),url('.$postedImage.') top center / cover no-repeat fixed;';
?>
		...
		<?php if (have_posts()): while (have_posts()) : the_post(); ?>
			...
			<section class="mission header-sync">
				...
				<div class="content">
					...
					<h2 class="marker">Our Mission<div class="multiSwipe"></div></h2>
					...
					?></p>
					<a class="button secondary-light-bg" href="/about">Learn More</a>
				</div>
				</div>
			</section>
			<section class="who-what" style="<?php echo $postedBG ?>">
				<div class="top"></div>
