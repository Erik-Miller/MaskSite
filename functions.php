...
function boilerplate_header_scripts(){
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('scripts', get_template_directory_uri() . '/dist/js/main.js', array('jquery'), '1.0.0', $in_footer = true); // Custom scripts
        wp_enqueue_script('scripts'); // Enqueue it!

        wp_register_script('magnific', get_template_directory_uri() . '/dist/js/thirdparty/jquery.magnific-popup.js', array('jquery'), '1.0.0', $in_footer = true); // Custom scripts
